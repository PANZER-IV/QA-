            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String data= "username="+ URLEncoder.encode(usernameStr,"utf-8")+"&password="+ URLEncoder.encode(passwordStr,"utf-8")+"&sign="+URLEncoder.encode("1","utf-8");
                        String path="http://192.168.43.185:8080/chatWeb/RegisterServlet";
                        ...
                        if(code==200){
                            ...
                            message.what=REGISTERSUCCESS;//用来标志是哪个消息
